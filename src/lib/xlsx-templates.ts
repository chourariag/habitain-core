...
export const TEMPLATES = {
  ...
  boq: {
    ...
    sheet: "BOQ",
    headers: ["S.No", "Category", "Item Description", "Unit", "Tender Qty", "GFC Qty", "Wastage %", "BOQ Qty", "Material Rate (₹)", "Labour Rate (₹)", "OH Rate (₹)", "BOQ Rate (₹)", "Tender Amount (₹)", "GFC Amount (₹)", "Margin %", "Scope (Factory / On-Site Civil / Both)"] as const,
    sample: [] as const,
  },
  budget: {
