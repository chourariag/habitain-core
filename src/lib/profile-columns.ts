...
// PII columns (phone, date_of_birth, wedding_anniversary, children, home_base) are
...
export const PROFILE_SAFE_COLUMNS =
  "id, auth_user_id, display_name, role, language, reporting_manager_id, is_active, login_type, is_archived, created_at, updated_at, avatar_url, onboarding_completed, onboarding_completed_at, onboarding_quiz_scores, department, secondary_manager_id";
