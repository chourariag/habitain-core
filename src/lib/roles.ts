...
export const ROLE_TIERS: Record<string, AppRole[]> = {
  ...
  "Tier 1 — Directors & MD": ["chairman", "managing_director", "finance_director", "sales_director", "architecture_director", "principal_architect"] as AppRole[],
  ...
  "Architects": ["senior_architect", "project_architect", "structural_architect"] as AppRole[],
};
