...
const SAMPLE_SEED = `Full Name, email@altree.in, role_key, Department, manager@altree.in
# Lines starting with # are ignored. Manager email is optional.
# Example:
# Aarav Sharma, aarav@altree.in, production_head, Operations, md@altree.in`;
