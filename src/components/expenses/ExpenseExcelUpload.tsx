...
export function ExpenseExcelUpload() {
  ...
  const downloadTemplate = () => {
    ...
    // Reference sheet: valid categories (replaces non-standard !dataValidation)
    const catSheet = XLSX.utils.aoa_to_sheet([
      ["Valid Categories for Column B"],
      ...
      <CardContent className="space-y-4">
        ...
        {win.isOpen ? (
          ...
          <div className="rounded-md px-3 py-2 text-xs font-inter" style={{ backgroundColor: "#FFF3CD", color: "#7a5c00" }}>
            Submission window is currently closed. Next window opens on {win.nextWindow}.
          </div>
        )}
          ...
          <div className="space-y-3">
                    ...
                    return (
                      <tr key={i} className="border-t border-border" style={{ backgroundColor: hasErr ? "#FDE8E8" : "white" }}>
                        ...
                        <td className="px-2 py-1.5 font-inter font-semibold" style={{ color: "#006039" }}>
                          {hasErr ? "—" : `₹${r.calculatedAmount.toLocaleString("en-IN")}`}
                        </td>
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <Button
                ...
                disabled={!validRows.length || !win.isOpen || submitting}
