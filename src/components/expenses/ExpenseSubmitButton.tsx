...
import { SubmitExpenseDrawer } from "./SubmitExpenseDrawer";
...
export function ExpenseSubmitButton({ userRole }: Props) {
  ...
  return (
    <>
      <div className="rounded-lg border border-border p-4 flex items-center justify-between flex-wrap gap-3"
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: "#666" }}>Submit expenses for approval</p>
          </div>
        </div>
      ...
      <SubmitExpenseDrawer open={open} onOpenChange={setOpen} />
    </>
  );
}
