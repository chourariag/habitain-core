...
BEGIN
  ...
  SELECT id INTO _closer_profile_id
  FROM public.profiles
  WHERE auth_user_id = auth.uid();

  IF _closer_profile_id IS NULL THEN
    RAISE EXCEPTION 'No staff profile is linked to the signed-in user';
  END IF;
